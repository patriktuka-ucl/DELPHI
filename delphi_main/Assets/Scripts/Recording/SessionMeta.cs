...
namespace Delphi
{
    ...
    /// session without guessing: capture fps (video frame N ↔ csv row N),
    /// which scalar channels were logged, and which video feeds exist.
    /// </summary>
    [Serializable]
    public class SessionMeta
    {
        public string started;          // ISO-8601 wall-clock start
        public int fps;                 // capture rate: video frames AND csv rows per second
